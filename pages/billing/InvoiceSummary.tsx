...
const InvoiceStatusChip: React.FC<{ status?: InvoiceStatus }> = ({ status }) => {
  ...
  // Added dark mode variants for better contrast
  const statusStyles: Record<InvoiceStatus, string> = {
    'Not Generated': 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300',
    'Generated': 'bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300 border dark:border-blue-500/50',
    'Sent': 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300 border dark:border-yellow-500/50',
    'Paid': 'bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 border dark:border-green-500/50',
  };
  return (
