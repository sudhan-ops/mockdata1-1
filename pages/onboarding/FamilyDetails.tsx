                ...
                {fields.map((field, index) => (
                    <div key={field.id} className="p-4 border border-border rounded-xl relative">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <Controller name={`family.${index}.dob`} control={control} render={({ field }) => <DatePicker label="Date of Birth" id={field.name} value={field.value} onChange={field.onChange} error={errors.family?.[index]?.dob?.message} />} />
